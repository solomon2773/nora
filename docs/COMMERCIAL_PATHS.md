...
Nora is open source at the core. The commercial motion should sit around rollout speed, support, and deployment scope — not around unsupported usage claims.
...
### 3. Managed Nora / custom deployment
Best for teams exploring a hosted evaluation path or a tailored rollout around OpenClaw operations.

Current public motion:
- pricing page for packaging context
...
- Avoid vanity metrics, fake social proof, or public price points that are not backed by the product reality.
- Use the open-source repo as the trust anchor.
- Monetize speed, support, and deployment scope.

## In-repo proof assets

- `docs/assets/proof-landing-open-source-funnel.png`
- `docs/assets/proof-pricing-commercial-paths.png`
- `docs/assets/nora-commercial-funnel.svg`

## Recommended next reuse

- add the screenshots to launch/status posts
- use the commercial funnel asset in README or pricing docs
- reuse the three-path framing in GitHub bio, X/LinkedIn posts, and Discord updates
