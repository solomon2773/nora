...
# segment-writer/02), and those are not what this row is about. So a
...
#
# Line identity is (message, ts), as segment-writer/02 established:
...
test_start "search" "03-flush-between-buffer-and-storage-read"
